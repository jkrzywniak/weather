const WeatherApp = class {
    constructor(apiKey, resultsBlockSelector) {
        ...
        this.currentWeatherBlock = document.getElementById('current-weather');
        this.forecastWeatherBlock = document.getElementById('forecast-weather')
    }
    ...
    drawWeather() {
        ...
        if (this.currentWeather) {
            ...
            const temperature = Math.round(this.currentWeather.main.temp);
            const feelsLikeTemperature = Math.round(this.currentWeather.main.feels_like);
        ...
        if (this.forecast && this.forecast.length > 0) {
            for (let i = 0; i < this.forecast.length; i++) {
                ...
                const feelsLikeTemperature = Math.round(weather.main.feels_like);
